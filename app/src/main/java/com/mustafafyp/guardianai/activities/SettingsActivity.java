...
import com.mustafafyp.guardianai.dialogfragments.AccountDeleteDialogFragment;
import com.mustafafyp.guardianai.dialogfragments.ConfirmationDialogFragment;
import com.mustafafyp.guardianai.dialogfragments.LanguageSelectionDialogFragment;
import com.mustafafyp.guardianai.dialogfragments.PasswordChangingDialogFragment;
import com.mustafafyp.guardianai.interfaces.OnConfirmationListener;
import com.mustafafyp.guardianai.interfaces.OnDeleteAccountListener;
import com.mustafafyp.guardianai.interfaces.OnLanguageSelectionListener;
import com.mustafafyp.guardianai.interfaces.OnPasswordChangeListener;
import com.mustafafyp.guardianai.utils.AccountUtils;
...
//		});
	...
	private void SendFeedBack() {
		...
		intent.putExtra(Intent.EXTRA_SUBJECT, "ChildCare Feedback");
		intent.putExtra(Intent.EXTRA_TEXT, body);
		startActivity(Intent.createChooser(intent, getString(R.string.choose_email_client)));
	}
	
	private void visitWebsite() {
		Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://dailyhunt-bf669.firebaseapp.com"));
