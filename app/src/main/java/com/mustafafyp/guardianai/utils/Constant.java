...
public class Constant {
	public static final String CHILD_NAME_EXTRA = "com.mansourappdevelopment.androidapp.kidsafe.utils.CHILD_NAME_EXTRA";
	public static final String CHILD_EMAIL_EXTRA = "com.mansourappdevelopment.androidapp.kidsafe.utils.CHILD_EMAIL_EXTRA";
	...
	public static final int READ_SMS_PERMISSION_REQUEST_CODE = 2;
	public static final int RECEIVE_SMS_PERMISSION_REQUEST_CODE = 3;
	public static final int READ_PHONE_STATE_PERMISSION_REQUEST_CODE = 4;
	public static final int READ_CALL_LOG_PERMISSION_REQUEST_CODE = 5;
	...
	public static final String PERMISSION_EXPLANATION_FRAGMENT_TAG = "com.mansourappdevelopment.androidapp.kidsafe.utils.PERMISSION_EXPLANATION_FRAGMENT_TAG";
	public static final int PERMISSIONS_MAIN_FRAGMENT = 0;
	public static final int PERMISSIONS_SMS_FRAGMENT = 1;
